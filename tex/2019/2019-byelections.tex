...
Fiona Twycross and Tom Copley (Lab, London-wide list) both resigned in March 2019.  They were replaced from the list by Murad Qureshi and Alison Moore.
...
Kezia Dugdale (Lab, Lothian) resigned on 15 July 2019.  She was replaced from the list by Sarah Boyack.
...
The following members were co-opted to the Assembly in 2019:
\begin{itemize}
\item Maolíosa McHugh (SF) replaced Michaela Boyle following her election to Derry and Strabane council in May 2019 (West Tyrone).
\item Máire Hendron (All) replaced Naomi Long following her election as an MEP in May 2019 (Belfast East).
\item Harry Harvey (DUP) replaced Simon Hamilton following his resignation in September 2019 (Strangford).
\item Rachel Woods (Grn) replaced Steven Agnew following his resignation in October 2019 (North Down).
\item Sinéad McLaughlin (SDLP) replaced Colum Eastwood following his election as an MP in December 2019 (Foyle).
\item Andrew Muir (All) replaced Stephen Farry following his election as an MP in December 2019 (North Down).
\item Matthew O'Toole (SDLP) replaced Claire Hanna following her election as an MP in December 2019 (Belfast South).
\item Diane Dodds (DUP) replaced Carla Lockhart following her election as an MP in December 2019 (Upper Bann).
\end{itemize}
...
\sloppyword{Aldermanic election: resignation of Sir Charles Bowman (Ind).}
...
See page \pageref{SalfordWalkdenSouth} for the result.
...
See page \pageref{NorthDevonChittlehampton} for the result.
...
\subsubsection*{St Andrew's and Docklands \hspace*{\fill}\nolinebreak[1]%
	\enspace\hspace*{\fill}
	\finalhyphendemerits=0
	[5th September]}

\index{Saint Andrew's and Docklands , Kingston upon Hull@St Andrew's \& Docklands, \emph{Kingston upon Hull}}
...
See page \pageref{TendringStOsyth} for the result.
...
See page \pageref{ForestDeanNewentTaynton} for the result.
...
See page \pageref{HerefsRossNorth} for the result.
...
See page \pageref{SouthRibbleFaringtonWest} for the result.
...
See page \pageref{BroxtoweStaplefordSouthEast} for the result.
...
\index{Wellington Rockwell Green and West , Taunton Deane@Wellington Rockwell Green \& W., \emph{Taunton Deane}}
...
See page \pageref{SouthStaffsWombourneSouthWest} for the result.
...
Jacob Taylor & C & 128\\
Daphne Bush & Ind & 58\\
\sloppyword{Shirley Hammond-Williams} & LD & 57\\
...
\noindent
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} p{0.53\columnwidth} >{\itshape}l r @{\extracolsep{\fill}}}
	\multicolumn{3}{@{\extracolsep{\fill}}l}{\emph{Four candidates eliminated}}\\	%\emph{}\\
...
\emph{Boyd, McOwan and Chamberlain eliminated}: Glen 1761 Boubaker-Calder 1343 Dodds 1202
...
\noindent
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} p{0.53\columnwidth} >{\itshape}l r @{\extracolsep{\fill}}}
	\multicolumn{3}{@{\extracolsep{\fill}}l}{\emph{Barsby and Aitchison eliminated}}\\	%\emph{}\\
	Laura Powell & C & 1339\\
	Jock McKay & SNP & 1184\\
\end{tabular*}
