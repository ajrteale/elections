...
The following members were co-opted to the Assembly in 2018:
\begin{itemize}
\item John Blair (All) replaced David Ford following his resignation on 25th June (South Antrim).
\item Emma Sheerin (SF) replaced Ian Milne following his resignation on 1st December (Mid Ulster).
\end{itemize}
...
See page \pageref{WillesdenGreenBrent} for the result.
...
At the May 2018 ordinary election there were unfilled vacancies in Bedfont, Chiswick Riverside and Hanworth Park wards due to the resignations of Sachin Gupta (Lab), Felicity Barwood (C) and Tina Howe (Lab) respectively.\index{Bedfont , Hounslow@Bedfont, \emph{Hounslow}}\index{Chiswick Riverside , Hounslow@Chiswick Riverside, \emph{Hounslow}}\index{Hanworth Park , Hounslow@Hanworth Park, \emph{Hounslow}}
...
See page \pageref{LondonBridgeWestBermondseySouthwark} for the result.
...
See page \pageref{EdgeleyCheadleHeathStockport} for the result.
...
\sloppyword{Resignation of Gurcharan Singh Sidhu (Lab).}
...
\subsubsection*{\sloppyword{Westbury-on-Trym and Henleaze} \hspace*{\fill}\nolinebreak[1]%
\enspace\hspace*{\fill}
\finalhyphendemerits=0
...
\subsubsection*{\sloppyword{Newport Pagnell North and Hanslope} \hspace*{\fill}\nolinebreak[1]%
\enspace\hspace*{\fill}
\finalhyphendemerits=0
[18th January]}
...
\index{Holsworthy , Torridge@Holsorthy, \emph{Torridge}}
...
\sloppyword{Resignation of Lloyd Russell-Moyle MP (Lab).}
...
Combined with the 2018 ordinary election; see page \pageref{PitseaSouthEastBasildon} for the result.
...
Combined with the 2018 ordinary election; see page \pageref{MoretonFyfieldEppingForest} for the result.
...
\noindent
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} p{0.53\columnwidth} >{\itshape}l r @{\extracolsep{\fill}}}
Andrew Jefferies (\emph{elected}) & C & 696\\
...
\subsubsection*{\sloppyword{Sutton Junction and Harlow Wood} \hspace*{\fill}\nolinebreak[1]%
	\enspace\hspace*{\fill}
	\finalhyphendemerits=0
	[Wednesday 12th December; Ashfield gain from Lab]}

\index{Sutton Junction and Harlow Wood , Ashfield@Sutton Jn \& Harlow Wood, \emph{Ashfield}}

Resignation of Steven Carroll (Ashfield elected as Lab).
...
\sloppyword{NottmInd = Nottingham Independents Putting Clifton First}
...
See page \pageref{BicesterWestCherwell} for the result.
...
Combined with the 2018 ordinary election; see page \pageref{FreelandHanboroughWestOxfordshire} for the result.
...
\index{Shifnal South and Cosford , Shropshire@Shifnal S. \& Cosford, \emph{Salop.}}
...
See page \pageref{GlascoteTamworth} for the result.
...
\index{Wenhaston and Westleton , Suffolk Coastal@\sloppyword{Wenhaston \& Westleton, \emph{Suffolk Coastal}}}
...
\index{Pembroke: Saint Mary North , Pembrokeshire@Pembroke: St Mary N., \emph{Pembs.}}
...
\emph{Armstrong eliminated:} J Wallace 1803 Macdonald 1469 V Wallace 1414
...
\index{Wester Ross, Strathpeffer and Lochalsh , Highland@Wester Ross, Strathpeffer and Lochalsh, \emph{Highland}}
