...
\index{Oldham East and Saddleworth@Oldham E. \& Saddleworth}
...
\index{Barnsley Central@Barnsley C.}
...
\index{Leicester South@Leicester S.}
...
\index{Feltham and Heston@Feltham \& Heston}
...
\index{Brompton , Kensington and Chelsea@Brompton, \emph{Kensington and Chelsea}}
...
\index{Queen's Gate , Kensington and Chelsea@Queen's Gate, \emph{Kensington and Chelsea}}
...
\index{Surbiton Hill , Kingston upon Thames@Surbiton Hill, \emph{Kingston u. Thames}}
...
\index{Coombe Vale , Kingston upon Thames@Coombe Vale, \emph{Kingston u. Thames}}
...
Combined with the 2011 ordinary election; see page \pageref{HorwichNorthEastBolton} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{BurnageManchester} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{ReddishNorthStockport} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{AltrinchamTrafford} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{GreasbyFrankbyIrbyWirral} for the result.
...
\index{Saint Helen's , Barnsley@St Helen's, \emph{Barnsley}}
...
\index{Elswick , Newcastle upon Tyne@Elswick, \emph{Newcastle u. Tyne}}

Death of Doreen James (Lab).

Combined with the 2011 ordinary election; see page \pageref{ElswickNewcastleTyne} for the result.
...
See page \pageref{WesterhopeNewcastleTyne} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{SandhillSunderland} for the result.

\section[West Midlands]{W.\ Midlands}
...
Combined with the 2011 ordinary election; see page \pageref{AldridgeCentralSouthWalsall} for the result.
...
\section[West Yorkshire]{W. Yorks.}
...
Combined with the 2011 ordinary election; see page \pageref{IdleThackleyBradford} for the result.
...
\index{Hazlemere South , Wycombe@Hazlemere South, \emph{Wycombe}}
...
Combined with the 2011 ordinary election; see page \pageref{CherryHintonCambridge} for the result.

\subsection*{East Cambridgeshire}

\index{Fordham Villages , East Cambridgeshire@\sloppyword{Fordham Villages, \emph{East Cambs.}}}
...
Combined with the 2011 ordinary election; see page \pageref{TheHemingfordsHuntingdonshire} for the result.
...
\index{Saint Neots Eaton Socon , Huntingdonshire@St Neots Eaton Socon, \emph{Huntingdonshire}}

Resignation of Mandy Thomas (C).

Combined with the 2011 ordinary election; see page \pageref{StNeotsEatonSoconHuntingdonshire} for the result.
...
See page \pageref{CreweSouthCheshireEast} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{WestbrookWarrington} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{AmblesideGrasmereSouthLakeland} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{LevensSouthLakeland} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{HeageAmbergateAmberValley} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{ShipleyParkHorsleyHorsleyWoodhouseAmberValley} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{AbbeyDerby} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{NormantonDerby} for the result.
...
\index{Clare and Shuttern , Mid Devon@Clare and Shuttern, \emph{Mid Devon}}
...
Combined with the 2011 ordinary election; see page \pageref{StPeterWaterfrontPlymouth} for the result.

\subsection*{Torbay}

\index{Roundham-with-Hyde , Torbay@Roundham-w/-Hyde, \emph{Torbay}}
...
\index{Westbourne , Brighton and Hove@Westbourne, \emph{Brighton and Hove}}
...
\index{Uckfield Ridgewood , Wealden@Uckfield Ridgewood, \emph{Weald\-en}}
...
\section[East Yorkshire]{E. Yorks.}
...
Combined with the 2011 ordinary election; see page \pageref{FryernsBasildon} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{IngatestoneFryerningMountnessingBrentwood} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{NailsworthStroud} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{PopleyEastBasingstokeDeane} for the result.

\subsection*{East Hampshire}

\index{Whitehill Pinewood , East Hampshire@Whitehill Pinewood, \emph{East Hants.}}
...
\index{Bishops Stortford West , Hertfordshire@Bishops Stortford W., \emph{Herts.}}
...
\index{Bishop's Stortford Silverleys , East Hertfordshire@Bishop's Stortford Silverleys, \emph{E. Hertfordshire}}
...
Combined with the 2011 ordinary election; see page \pageref{StPetersStAlbans} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{BearstedMaidstone} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{EastMaidstone} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{BrenchleyHorsmondenTunbridgeWells} for the result.
...
\index{Beardwood with Lammack , Blackburn with Darwen@Beardwood with Lammack, \emph{Blackburn w/ Darwen}}
...
\index{Rosehill with Burnley Wood , Burnley@Rosehill w/ Burnley Wood, \emph{Burnley}}
...
\index{Rosegrove with Lowerhouse , Burnley@Rosegrove w/ Lowerhouse, \emph{Burnley}}
...
Combined with the 2011 ordinary election; see page \pageref{RuffordWestLancashire} for the result.

\section[Leicestershire]{Leics.}
...
\index{Thornton Dale and Wolds , North Yorkshire@Thornton Dale and The Wolds, \emph{N. Yorks.}}
...
\index{Southwell East , Newark and Sherwood@\sloppyword{Southwell East, \emph{Newark and Sherwood}}}
...
See page \pageref{ManversRushcliffe} for the result.
...
\index{Didcot Northbourne , South Oxfordshire@Didcot Northbourne, \emph{S. Oxfordshire}}
...
\index{Quarry and Coton Hill , Shropshire@Quarry \& Coton Hill, \emph{Shropshire}}
...
Combined with the 2011 ordinary election; see page \pageref{KidsgroveNewcastleLyme} for the result.
...
See page \pageref{SeabridgeNewcastleLyme} for the result.
...
\index{Oulton Broad , Waveney@\sloppyword{Oulton Broad, \emph{Waveney}}}

\index{Southwold and Reydon , Waveney@Southwold and Reydon, \emph{Waveney}}
...
Combined with the 2011 ordinary election; see page \pageref{GoldsworthEastWoking} for the result.

\section[Warwickshire]{Warks.}
...
Combined with the 2011 ordinary election; see page \pageref{HarburyStratfordAvon} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{LongItchingtonStratfordAvon} for the result.
...
Combined with the 2011 ordinary election; see page \pageref{GreenlandsRedditch} for the result.
...
\index{Llanegwad , Carmarthenshire@Llanegwad, \emph{Carms.}}
...
\subsubsection*{\sloppyword{Airyhall\slash{}Broomhill\slash{}Garthdee} \hspace*{\fill}\nolinebreak[1]%
\enspace\hspace*{\fill}
\finalhyphendemerits=0
...
\index{Saltcoats and Stevenston , North Ayrshire@Saltcoats \& Stevenston, \emph{N. Ayrs.}}
...
\noindent
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} p{0.545\columnwidth} >{\itshape}l r @{\extracolsep{\fill}}}
\emph{Exclude Hoyle, Craig and Baillie}\\
Ken Andrew & SNP & 1079\\
