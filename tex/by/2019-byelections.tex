...
\begin{resultsiii}
	...
	Aldermanic election: Sir Charles Bowman (Ind) sought re-election.
	...
	\sloppyword{Aldermanic election: Peter Estlin (Ind) sought re-election.}
	...
	\index{Fulham Broadway , Hammersmith and Fulham@\sloppyword{Fulham Broadway, \emph{Hammersmith \& Fulham}}}
	...
	\sloppyword{Resignation of Mohammad HM Harun (Lab).}
...
%	; see page \pageref{SouthTynesideCleadonEastBoldon} for the result.
	...
	\sloppyword{At the May 2019 ordinary election there was an unfilled vacancy in Washington South ward due to the disquali{fi}cation (non-attendance) of Paul Middleton (Lab).}
...
%	; see page \pageref{ThamesReading} for the result.
	...
	\index{Riverside , Windsor and Maidenhead@\sloppyword{Riverside, \emph{Windsor \& Maidenhead}}}
...
\columnbreak
	...
	\subsubsection*{Aveley and Uplands \hspace*{\fill}\nolinebreak[1]%
		\enspace\hspace*{\fill}
		\finalhyphendemerits=0
		[21st March; C gain from Thurrock]}

	\index{Aveley and Uplands , Thurrock@Aveley \& Uplands, \emph{Thurrock}}

	Resignation of Tim Aker MEP (Thurrock).
...
\index{Herefordshire}
	...
	\subsubsection*{\sloppyword{Broxbourne and Hoddesdon South} \hspace*{\fill}\nolinebreak[1]%
		\enspace\hspace*{\fill}
		\finalhyphendemerits=0
		[2nd May]}
...
%	; see page \pageref{WatfordMeriden} for the result.
	...
	\sloppyword{Resignation of Kerstin Holman-Schmidt (C).}
...
\columnbreak
	...
	\index{Whippingham and Osborne , Isle of Wight@\sloppyword{Whippingham \& Osborne, \emph{Isle of Wight}}}
...
%	; see page \pageref{NorthEastLincolnshireSouth} for the result.
	...
	\noindent
	\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} p{0.545\columnwidth} >{\itshape}l r @{\extracolsep{\fill}}}
		\sloppyword{Annabel de Capell Brooke} & C & 1864\\
	...
	\index{Irthlingborough Waterloo , East Northamptonshire@\sloppyword{Irthlingborough Waterloo, \emph{E. Northants.}}}
...
%	; see page \pageref{CherwellKidlingtonWest} for the result.
	...
	Disqualification (bankruptcy restrictions order) of Sukhi Sanghera (C).
	...
	\index{Llanbadarn Fawr Sulien , Ceredigion@\sloppyword{Llanbadarn Fawr Sulien, \emph{Ceredigion}}}
