...
\section*{Thirsk and Malton}\label{ThirskMalton} \index{Thirsk and Malton} \begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} p{0.545\columnwidth} >{\itshape}l r @{\extracolsep{\fill}}}
...
\index{Eltham South , Greenwich@Eltham South, \emph{Greenwich}}
...
\index{Wisbech Kirkgate , Fenland@Wisbech Kirkgate, \emph{Fenland}}
...
At the May 2010 ordinary election there was an unfilled vacancy in Christchurch ward due to the resignation of Naseem Shabnam (LD).
...
\index{Redwell West , Wellingborough@Redwell West, \emph{Wellingborough}}
...
\index{Kidlington North , Cherwell@Kidlington North, \emph{Cherwell}}
...
\index{Clee , Shropshire@Clee, \emph{Salop.}}
...
\index{Walton South and Oatlands , Surrey@Walton South and Oatlands, \emph{Surrey}}
...
\index{Capel, Leigh and Newdigate , Mole Valley@Capel, Leigh and Newdigate, \emph{Mole Valley}}
...
\index{Bromham, Roade and Potterne , Wiltshire@Bromham, Roade \& Potterne, \emph{Wilts.}}
...
\index{Cenarth , Carmarthenshire@Cenarth, \emph{Carms.}}
...
\index{Liberton/Gilmerton , Edinburgh@Liberton/\hspace{0pt}Gilmerton, \emph{Edinburgh}}
