...
\sloppyword{Aldermanic election: Fiona Woolf (Ind) sought re-election.}
...
\sloppyword{Aldermanic election: Alan Yarrow (Ind) sought re-election.}
...
\index{Camden Town with Primrose Hill , Camden@\sloppyword{Camden Town with Primrose Hill, \emph{Camden}}}
...
\subsubsection*{\sloppyword{Herongate, Ingrave and West Horndon} \hspace*{\fill}\nolinebreak[1]%
\enspace\hspace*{\fill}
\finalhyphendemerits=0
[3rd May]}
...
Resignation of Michele Jeffery (C).
...
\index{Woodhall Farm , Dacorum@Woodhall Farm, \emph{Dacorum}}
...
\index{Loughborough Southfields , Charnwood@\sloppyword{Loughborough South{fi}elds, \emph{Charnwood}}}
...
Resignation of Andrew Ferryman (MSSF).

\noindent
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} p{0.52\columnwidth} >{\itshape}l r @{\extracolsep{\fill}}}
Steve Palmer & MSSF & 330\\
David Andrews & C & 118\\
Joyce Taylor & Lab & 90\\
Ian Wild & Ind & 63\\
\end{tabular*}
...
\index{North Ormesby and Brambles Farm , Middlesbrough@\sloppyword{North Ormesby \& Brambles Farm, \emph{Middlesbrough}}}
...
\subsubsection*{\sloppyword{Church Stretton and Craven Arms} \hspace*{\fill}\nolinebreak[1]%
\enspace\hspace*{\fill}
\finalhyphendemerits=0
[13th September]}

\index{Church Stretton and Craven Arms , Shropshire@\sloppyword{Church Stretton \& Craven Arms, \emph{Shrops.}}}
...
\index{Wombourne North and Lower Penn , South Staffordshire@\sloppyword{Wombourne N. \& Lower Penn, \emph{S. Sta{ff}s.}}}
...
\enspace\hspace*{\fill}
\finalhyphendemerits=0
[26th July; CityInd gain from Lab]}

\index{Springfields and Trent Vale , Stoke-on-Trent@\sloppyword{Spring{fi}elds \& Trent Vale, \emph{Stoke-on-Trent}}}
...
\subsubsection*{\sloppyword{Campsie and Kirkintilloch North} \hspace*{\fill}\nolinebreak[1]%
\enspace\hspace*{\fill}
\finalhyphendemerits=0
