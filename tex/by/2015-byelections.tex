...
Resignation of Stanley Knowles (Ind).
...
Resignation of Kenneth Ayers (Ind).
...
Resignation of John Owen-Ward (Ind).
...
Disqualification (non-attendance) of Charlene McLean (Lab).
...
\sloppyword{Disquali{fi}cation of Alibor Choudhury (THF): reported guilty of corrupt and illegal practices (bribery; making false statements about a candidate; paying canvassers) during the 2014 election of the Mayor of Tower Hamlets.}
...
\sloppyword{Adrian Hyyryläinen-Trett} & LD & 1748\\
...
\noindent
\begin{tabular*}{\columnwidth}{@{\extracolsep{\fill}} p{0.625\columnwidth} >{\itshape}l r @{\extracolsep{\fill}}}
...
Resignation of Sue Hayman MP (Lab).
...
Resignation of Andrew Lewer MEP (C).
...
BomoInd = Bournemouth Independent Alliance
...
Mel Semple & Lab & 371\\
Duane Farr & UKIP & 313\\
Philip Davenport & BomoInd & 168\\
Roger West & BomoInd & 116\\
...
\subsubsection*{North Highcliffe and Walkford (2) \hspace*{\fill}\nolinebreak[1]%
\enspace\hspace*{\fill}
\finalhyphendemerits=0
[18th June]}
...
Disqualification (non-attendance) of Mark Cable (C).
...
At the May 2015 ordinary election there was an unfilled vacancy in Coleford East ward due to the disqualification (non-attendance) of Tanya Palmer (Lab).
...
\index{Southborough North , Tunbridge Wells@\sloppyword{Southborough N., \emph{Tunbridge Wells}}}
...
\index{Market Harborough Logan , Harborough@\sloppyword{Market Harborough---Logan, \emph{Harborough}}}
...
\sloppyword{Ordinary election postponed from 7th May: death of outgoing councillor Reg Howard (Ind) who had been nominated for re-election.}
...
Resignation of Amanda Coulson (elected as Amanda van Niekerk, LD).
...
\subsubsection*{\sloppyword{Blakebrook and Habberley South} \hspace*{\fill}\nolinebreak[1]%
\enspace\hspace*{\fill}
\finalhyphendemerits=0
[24th September]}
...
Resignation of Janet Howarth AM (C).
...
Resignation of Liz Saville Roberts MP (PC).
...
\sloppyword{\emph{Williams eliminated}: Bonnar 1556 Ga{ff}ney 1417 Gallacher 158 McCabe 81 McAleer 55 Smith 37}
...
\sloppyword{\emph{MacKay and Cockburn eliminated}: Ross 1895 Lee 1410 Nailon 365 Kane 135 Smith 84}
...
\sloppyword{\emph{Davidson and Tedford eliminated}: Perry 1558 Miller 977 Winchester 570 Feldwick 420}
...
\sloppyword{\emph{Tollemache eliminated}: McLaughlan 1367 Kane 1134 Davison 352}
...
\sloppyword{\emph{MacGregor eliminated}: Fuller 2854 Cunningham 1890 McIvor 1440}
...
\enspace\hspace*{\fill}
\finalhyphendemerits=0
[Tuesday 18th August; ONG gain from Ind]}
